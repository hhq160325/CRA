...
const RegisterCar = () => {
  ...
  const handleNext = () => {
    // TODO: Navigate to next page (design to be provided later)
    console.log('Next button clicked - next page design to be provided');
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-xl font-semibold text-gray-900">Register Car</h1>
