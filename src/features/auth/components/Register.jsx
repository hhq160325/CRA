...
import { registerUser, clearError, selectIsLoading, selectError } from '../authSlice';
    ...
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="space-y-4 mb-8">
        <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
          ...
          <span className="text-gray-900 font-medium">Sign up with Facebook</span>
        </button>
      ...
      {/* Simple email form like in the image */}
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors mt-4"
        >
          <svg className="w-5 h-5 mr-3 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
          </svg>
          <span className="text-gray-900 font-medium">Sign up with SSO</span>
        </button>
      </form>
      </div>
    </div>
