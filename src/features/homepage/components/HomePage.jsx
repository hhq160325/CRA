...
const HomePage = () => {
  ...
  // Filter out cars with Reserved and Inactive status
  const activeCars = cars.filter(car => car.status && car.status.toLowerCase() !== 'reserved' && car.status.toLowerCase() !== 'inactive');
