...
const CarRegisDocs = () => {
  ...
  return (
    <div className="p-6">
      ...
      `}</style>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Car Registration Documents</h1>
        <p className="text-gray-600">Manage and track your car registration document approvals</p>
      </div>
                          ...
                          <div className="relative">
                            ...
                            {showTooltip === car.id && (
                              <div className="absolute left-0 top-full mt-2 w-64 bg-gray-900 text-white text-xs rounded-lg p-3 shadow-lg z-10 animate-fade-in">
                                ...
                                Your car registration documents are being reviewed by our team. This usually takes 1-2 business days.
                              </div>
                            )}
                          </div>
