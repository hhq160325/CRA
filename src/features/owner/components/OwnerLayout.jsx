            ...
            <nav className="space-y-2">
              ...
              <div className="pt-4 border-t mt-4">
                ...
                <nav className="space-y-1">
                  ...
                  <Link to="/owner/car-regis-docs" className={`block px-3 py-2 rounded-lg ${isActive('/owner/car-regis-docs') ? 'text-white bg-blue-600' : 'text-gray-600 hover:bg-gray-50'}`}>{t('submitVehicleRegistrationCertificate')}</Link>
                </nav>
              </div>
            </nav>
          </div>
